...
public:
  ...
  void AddHalfedge(const unsigned int opposite, const unsigned int next,
                   const unsigned int prev, const unsigned int vertex,
  ...
  void SetOpposite(const unsigned int halfedge_no,
                   const unsigned int opposite) {
...
public:
  ...
  void SetHalfedge(const unsigned int vertex_no,
                   const unsigned int halfedge_no) {
