...
inline double area(const Point3& point_a, const Point3& point_b,
                   const Point3& point_c) {
...
public:
  RandomDoubleUniform(const double from, const double to)
    : distribution_(from, to) {
  }
...
inline Point3 RandomPointInTriangle(const Point3& point_a,
